...
import com.wahyusembiring.lecturer.screen.addlecture.AddLecturerScreenViewModel
import com.wahyusembiring.lecturer.screen.main.LecturerScreen
import com.wahyusembiring.lecturer.screen.main.LecturerScreenViewModel
...
import com.wahyusembiring.agenda.CreateReminderScreen
import com.wahyusembiring.agenda.AddAgendaScreenViewModel
...
fun NavGraphBuilder.createHomeworkScreen(
    ...
    composable<Screen.CreateHomework> {
        ...
        val viewModel: AddTaskScreenViewModel = hiltViewModel(
            viewModelStoreOwner = it,
            creationCallback = { factory: AddTaskScreenViewModel.Factory ->
...
fun NavGraphBuilder.examScreen(
    ...
    composable<Screen.CreateExam> {
        ...
        val viewModel: AddExamScreenViewModel = hiltViewModel(
            viewModelStoreOwner = it,
            creationCallback = { factory: AddExamScreenViewModel.Factory ->
...
fun NavGraphBuilder.createReminderScreen(
    ...
    composable<Screen.CreateReminder> {
        ...
        val viewModel: AddAgendaScreenViewModel = hiltViewModel(
            viewModelStoreOwner = it,
            creationCallback = { factory: AddAgendaScreenViewModel.Factory ->
